...
?>
  <main id="main" class="main">
            ...
            <div class="card-body">
              <div class="row">
  	          	<div class="col-lg-6 py-3">
  	          		<a class="btn btn-success" id="add-manager">Add Manager</a>
  	          	</div>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php if($managers): foreach($managers as $user): ?>
                  <tr>
                    ...
                    <td>
                    	<a onclick="editManager(<?php echo $user->id; ?>)" class="text-success"><i class="bi bi-pencil"></i> Edit</a><br/>
    ...
    <!-- Add manager modal -->
    <div class="modal fade" id="addManagerModal" tabindex="-1" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form method="POST" action="">
            <div class="modal-header bg-primary">
              <h5 class="modal-title text-light">Add Manager</h5>
  ...
  <!-- Edit manager modal -->
    <div class="modal fade" id="editManagerModal" tabindex="-1" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form method="POST" action="" id="edit-form">
            <div class="modal-header bg-primary">
              <h5 class="modal-title text-light">Edit Manager</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <div class="row">
              ...
              <input type="hidden" name="manager_id" id="manager-id" value="">
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              <button type="submit" class="btn btn-primary">Save changes</button>
    ...
    $.ajax({
       ...
       success: function(data) {
          if(data) {
            ...
            $('#edit-form').find('#manager-id').val(obj[0].id);
