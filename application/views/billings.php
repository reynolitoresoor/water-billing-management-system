                ...
                <table class="table datatable">
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Receipt/Screenshot</th>
                  ...
                  <tbody>
                    <?php if($billings): foreach($billings as $bill): ?>
                    <tr>
                      <th scope="row"><?php echo $bill->id; ?></th>
                      <td><?php echo $bill->last_name.', '.$bill->first_name.' '.$bill->middle_name; ?></td>
                      <td>₱<?php echo number_format($bill->amount,'2','.',','); ?></td>
                      <td><?php if($bill->paid_amount){ ?>₱<?php echo number_format($bill->amount,'2','.',','); ?><?php } ?></td>
                      <td><?php echo $bill->due_date; ?></td>
                      <td><?php echo $bill->meter_from; ?></td>
                      <td><?php echo $bill->meter_to; ?></td>
                      <td><?php if($bill->receipt){echo '<a href="'.base_url().'uploads/receipts/'.$bill->receipt.'" target="_blank" title="View Receipt/Screenshot"><img width="100" class="img-responsive" src="'.base_url().'uploads/receipts/'.$bill->receipt.'" /></a>';} ?></td>
